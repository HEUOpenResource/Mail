...
import { mapleMono, mapleMonoCDN } from "./fonts"
import "./globals.css"
import { Providers } from "./providers"
import { FloatMenu } from "@/components/float-menu"

export const metadata: Metadata = {
  title: "HEU Mail  哈尔滨工程大学课程攻略共享计划-临时邮箱服务",
  ...
  return (
    <html lang="zh-CN" suppressHydrationWarning>
      <head>
        ...
        <link rel="stylesheet" href={mapleMonoCDN} />
        <script 
          defer 
          src="https://analytics.heu.us.kg/tracker.min.js" 
          data-website-id="临时邮箱服务"
        />
      </head>
      <body className={cn("min-h-screen bg-background antialiased", mapleMono.className)}>
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
